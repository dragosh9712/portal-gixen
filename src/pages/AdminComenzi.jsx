...
const NEXT_STATUSES = {
  plasata: ['in_aprobare', 'anulata'], in_aprobare: ['aprobata', 'anulata'],
  aprobata: ['in_procesare', 'anulata'], in_procesare: ['livrata', 'anulata'],
}
...
export default function AdminComenzi() {
  const { db, updateOrderStatus, setFactura, addNotaInterna, bulkUpdateOrderStatus } = useStore()
