  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
      ...
      <div style={{ background: 'var(--bg)', borderRadius: 10, padding: 14 }}>
        ...
        <Field label="PDF aviz" value={d.urlAviz} field="urlAviz" section="docs" placeholder="https://..." />
        <Field label="Nr. factură fiscală" value={d.nrFactura} field="nrFactura" section="docs" placeholder="ex: FX-1234" />
        <Field label="PDF factură" value={d.urlFactura} field="urlFactura" section="docs" placeholder="https://..." />
